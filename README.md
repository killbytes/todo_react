[Todo class link](https://todo-react-func.vercel.app/ "Click")
...
- "Clear completed" удаление всех Completed задач
...
- 
- rerender компонента
- rerender всего приложения
- мутация через ... (глубокого объекта)
